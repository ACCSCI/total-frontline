...
const NMAT = {
  ...
  trim: new THREE.MeshStandardMaterial({ color: 0xe9e5da, roughness: 0.7, metalness: 0.02 }),
  ...
  ceil: new THREE.MeshStandardMaterial({ color: 0xd8d4c8, roughness: 0.9, metalness: 0 }),
  ...
  truckWh: new THREE.MeshStandardMaterial({ color: 0xdcd8cc, roughness: 0.6, metalness: 0.06 }),
